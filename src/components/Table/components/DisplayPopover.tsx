      ...
      <div className="flex flex-wrap flex-col">
          <Popover>
            <PopoverTrigger asChild>
              <Button size="xs" variant="outline" className="rounded-md">
              ...
              {columns.map((col) => (
                <div key={col.key}
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <label htmlFor={col.key} className={`text-sm ${col.default ? "text-slate-400" : ""}`}>{col.label}</label>
                  </div>
                  <Switch className="data-[state=checked]:bg-sky-400 data-[state=unchecked]:bg-gray-200"  id={col.key}
